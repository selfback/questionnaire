<?php
    ...
    $noGood = false;
    $object = new Moond1($_SESSION['page_index']);
...
?>
                    ...
                    <table class="general-table">
                        <tr class="table-header">
                            <th class="table-question with-5-radio">&nbsp;</th>
<?php
    for($i = 0; $i < 5; $i++){
?>
                            <th class="radio-cell rotate radio-cell-painSelf"><div><span><?= $i ?> - <?= constant("P23_ANSWER_".$i) ?></span></div></th>
<?php
    }
?>
                        </tr>
