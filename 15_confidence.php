<?php
    ...
    $noGood = false;
    $object = new Confidence($_SESSION['page_index']);
        ...
        <div class="content">
            ...
            <div class="shadow">
                ...
                <form id="generalForm" action="" method="POST" class="general-form">
                    ...
                    <p>
                        <i class="i-info"><?= P15_LABEL_INFO ?></i>
                    </p>
<?php
    if($noGood){
?>                      
...
?>
                    ...
                    <table class="general-table">
                        <tr class="table-header">
                            <th class="table-question with-7-radio">&nbsp;</th>
                            <td colspan=7 class="with-7-radio-sub-tab">
                                <table class="sub-tab">
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="scale-info">
                                                <span class="scale-left no-padding-left scale-left-15">
                                                    <?= P15_SCALE_0 ?>
                                                </span>
